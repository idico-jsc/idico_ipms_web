...
export default defineConfig({
  ...
  resolve: {
    alias: [
      { find: "@atoms", replacement: path.resolve(__dirname, "./src/components/atoms/index.ts") },
      { find: /^@atoms\/(.*)$/, replacement: path.resolve(__dirname, "./src/components/atoms/$1") },
      { find: "@molecules", replacement: path.resolve(__dirname, "./src/components/molecules/index.ts") },
      { find: /^@molecules\/(.*)$/, replacement: path.resolve(__dirname, "./src/components/molecules/$1") },
      { find: "@organisms", replacement: path.resolve(__dirname, "./src/components/organisms/index.ts") },
      { find: /^@organisms\/(.*)$/, replacement: path.resolve(__dirname, "./src/components/organisms/$1") },
      { find: "@templates", replacement: path.resolve(__dirname, "./src/components/templates/index.ts") },
      { find: /^@templates\/(.*)$/, replacement: path.resolve(__dirname, "./src/components/templates/$1") },
      { find: "@pages", replacement: path.resolve(__dirname, "./src/components/pages/index.ts") },
